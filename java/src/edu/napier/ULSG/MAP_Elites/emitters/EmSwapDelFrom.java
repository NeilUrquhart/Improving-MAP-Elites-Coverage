...
public class EmSwapDelFrom extends Emitter {

	private Vehicle vehicle;
	private String vehName;
	
	public EmSwapDelFrom(MVehicleProblem prob, Vehicle v) {
		super(prob);
		vehicle =v;
	...
	public Elite emitt(Elite input) {
		...
		if (g!= null) {
			//Swap vehicle
			Vehicle v = problem.rndVehicle();
			while (v==vehicle)
				v = problem.rndVehicle();
